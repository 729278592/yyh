      ...
      <ul class="orderList">
          <li>
              <div>
                  ...
                  <div class="orderCon" v-for="shopList in list.shoppingList" style="border-bottom:1px solid #efefef;">
                      <div class="orderImg">
  ...
  <div class="weui_mask_transition" id="mask" :class="{'weui_fade_toggle':addClassFade}" @click="hideModal()"></div>
      <div class="weui_actionsheet style" :class="{'weui_actionsheet_toggle':addClassActionsheet}" id="weui_actionsheet">
              ...
              <li v-for="addressList in list.addressList">
               ...
               <div class="personInfor style">
                ...
                <div class="addressModify clearfix">
                    ...
                    <button class="btnModify right" v-link="{ name: 'modifyAddressInfor', params: {personname: addressList.personName,phone: addressList.phone,addressInfor: addressList.address}}">
        ...
        <div class="weui_btn_area style">
            <a class="weui_btn b0 weui_btn_primary" v-link="'/user/addAddress'">新增地址</a>
        </div>
    </div>
</div>
</template>
