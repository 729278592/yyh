          ...
          <div class="weui_cells weui_cells_form mt0 wauto">
              <div class="weui_cell">
                  ...
                  <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" @invalid="telonInvalid" initial="off" detect-change="off" v-model="mobile" id="mobile" type="tel" v-validate:mobile="['mobile']" value="13678478463"  placeholder='请输入手机号码'>
                  </div>
              </div>
              ...
              <div class="weui_cell">
                  ...
                  <div class="weui_cell_bd weui_cell_primary">
                      <input class="weui_input codeInput"  @invalid="isPostCodeInvalid" initial="off" detect-change="off" v-model="isPostCode" id="isPostCode" type="number" v-validate:isPostCode="['isPostCode']" value="1234" placeholder="验证码为4位有效数字"/>
              ...
              <div class="weui_cell">
                  ...
                  <div class="weui_cell_bd weui_cell_primary">
                      <input class="weui_input" @invalid="aginPasswordInvalid" initial="off" detect-change="off" v-model="aginPassword" id="aginPassword" type="password" v-validate:aginPassword="['passw']" placeholder="请确认密码"/>
                  </div>
              </div>
          </div>
