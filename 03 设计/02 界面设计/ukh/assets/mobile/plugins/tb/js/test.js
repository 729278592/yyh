    ...
    return $.extend(c.prototype, {
        ...
        _init: function () {
            ...
            if (a.options.trigger && (a._triggerHandler = $(a.options.trigger).on(c.eventType, function (b) {
                ...
                var d = '<div class="km-dialog km-dialog-ios7 km-dialog-' + c.type + (c.elCls ? " " + c.elCls : "") + '">';
        ...
        hide: function () {
            this.options.mask && this.hideMask(), $(".km-dialog").remove(), this.options.afterHide && this.options.afterHide()
        },
        destroy: function () {
        ...
        return $.extend(b.prototype,{
            ...
            _bindEvent: function () {
                ...
                this.cfg.submitBtn.on("click", function (b) {
                    b.preventDefault(), a.loginCheck() && ( a.submitForm())
            ...
            _initInputClear: function () {
                ...
                $.each(a, function (a, c) {
                    ...
                    d && e && (d.on("touchstart", function () {
                        e.val(""), e[0].focus(), d[0].style.visibility = "hidden", f.attr("disabled", "disabled")
                    }, !1), d.on("click", function () {
                        e.val(""), e[0].focus(), d[0].style.visibility = "hidden", f.attr("disabled", "disabled")
                    }, !1), e.on("focus", function () {
                        d[0].style.visibility = e.val().length > 0 ? "visible" : "hidden"
                    }, !1), e.on("input", function () {
                        d[0].style.visibility = e.val().length > 0 ? "visible" : "hidden"
            ...
            submitForm: function () {
                this.cfg.loginForm[0].submit() //提交表单
            },
            loginCheck: function () {
