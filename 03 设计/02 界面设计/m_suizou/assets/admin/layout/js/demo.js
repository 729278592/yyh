...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Main.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (Main.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Main.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Main.getGlobalCssPath() + file + ".css");
