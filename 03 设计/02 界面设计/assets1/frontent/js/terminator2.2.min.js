    ...
    var d = KClass.create({
        init: function(g) {
            ...
            if (h.eType == "mouseover") {
                ...
                if (h.eType == "click") {
                    b(this.mbox).bind("click",
                        function() {
                            i.timeManger1(i)
                        });
                    b(this.mbox).bind("mouseout",
                        function() {
                            i.timeManger2(i)
                        })
                } else {
        ...
        effects: {
            ...
            fade: function(h, i) {
                ...
                var f = h.cons.item(i).find("img").nitem(0); (function() {
            ...
            flip: function(i, j) {
                ...
                u = {
                    ...
                    onBefore: i.opt.onBefore ||
                        function() {},
                    onEnd: i.opt.onEnd ||
                        function() {},
                    onAnimation: i.opt.onAnimation ||
                        function() {}
                };
                ...
                var A = function() {
                    ...
                    w.go(B.second, i.opt.interval / 2, "",
                        function() {
        ...
        fixMoveTo: function(h) {
            var g = this,
                h,
                f;
            g.runId && clearTimeout(g.runId); (h > this.levels - 1) && (h = 0); (h < 0) && (h = this.levels - 1);
            if (this.opt.effect == "slide" || this.opt.effect == "fxslide" || this.opt.effect == "scroll") {
                g.to = "-" + h * this.ml;
                this.end = 0
            } else {
    ...
    var a = KClass.create({
        init: function(f) {
            ...
            if (g.bns && g.bns.length == 2) {
                ...
                h.scrEvent1 = h.btleft.bind("_mousedown",
                    function() {
                        h.ISL_GoUp(h)
                    });
                h.btMouse1 = h.btleft.bind("_mouseover",
                    function() {
                        this.toggleClass(h.prevMouseImg);
                        clearInterval(h.AutoPlayObj)
                    });
                h.mouseup1 = h.btleft.bind("_mouseup",
                    function() {
                        h.ISL_StopUp(h);
                        clearInterval(h.AutoPlayObj)
                    });
                h.ptMouse1 = h.btleft.bind("_mouseout",
                    function() {
                        this.toggleClass(h.prevMouseImg);
                        g.auto && h.AutoPlay(h)
                    });
                h.btMouse2 = h.btright.bind("_mouseover",
                    function() {
                        this.toggleClass(h.nextMouseImg);
                        clearInterval(h.AutoPlayObj)
                    });
                h.scrEvent2 = h.btright.bind("_mousedown",
                    function() {
                        h.ISL_GoDown(h);
                        h.test = 1
                    });
                h.mouseup2 = h.btright.bind("_mouseup",
                    function() {
                        h.ISL_StopDown(h);
                        clearInterval(h.AutoPlayObj)
                    });
                h.ptMouse2 = h.btright.bind("_mouseout",
                    function() {
        ...
        leftEvent: function(f) {
            f.scrEvent1 = f.btleft.bind("_mousedown",
                function() {
                    f.ISL_GoUp(f)
                });
            f.btMouse1 = f.btleft.bind("_mouseover",
                function() {
                    this.toggleClass(f.prevMouseImg);
                    clearInterval(f.AutoPlayObj)
                });
            f.mouseup1 = f.btleft.bind("_mouseup",
                function() {
                    f.ISL_StopUp(f);
                    clearInterval(f.AutoPlayObj)
                });
            f.ptMouse1 = f.btleft.bind("_mouseout",
                function() {
                    this.toggleClass(f.prevMouseImg);
        ...
        rightEvent: function(f) {
            ...
            clearInterval(f.AutoPlayObj);
            f.mouseup2 = f.btright.bind("touchend",
                function() {
                    f.ISL_StopDown(f);
                    clearInterval(f.AutoPlayObj)
                });
        ...
        enabbtright: function(f) {
            ...
            f.btMouse2 = f.btright.bind("_mouseover",
                function() {
                    this.toggleClass(f.nextMouseImg);
                    clearInterval(f.AutoPlayObj)
                });
            f.scrEvent2 = f.btright.bind("_mousedown",
                function() {
                    f.ISL_GoDown(f)
                });
            f.mouseup2 = f.btright.bind("_mouseup",
                function() {
                    f.ISL_StopDown(f)
                });
            f.ptMouse2 = f.btright.bind("_mouseout",
                function() {
                    this.removeClass(f.nextMouseImg);
                    f.opt.auto && f.AutoPlay(f)
                });
        ...
        ISL_GoDown: function(f) { ! f.loop && f.enabbtleft(f);
        ...
        ISL_GoUp: function(f) { ! f.loop && f.enabbtright(f);
            clearInterval(f.MoveTimeObj);
            if (f.MoveLock) {
                return
            }
        ...
        ISL_ScrUp: function(f) {
            if (f.vertical == "left") {
                ...
                if ( - f.scrObj.Left() <= f.PageWidth) { ! f.loop && f.disbtleft(f); ! f.loop && f.opt.auto && setTimeout(function() {
                        f.AutoPlay(f)
                    },
                    f.interval)
                }
                ...
                if ( - f.scrObj.Top() <= f.PageWidth) { ! f.loop && f.disbtleft(f); ! f.loop && f.opt.auto && setTimeout(function() {
                        f.AutoPlay(f)
                    },
                    f.interval)
                }
