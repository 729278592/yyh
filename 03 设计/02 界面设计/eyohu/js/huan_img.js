...
com.initializeCss=function(){
        ...
        $('#imgfor_con').css({width:fa1_wid+235,height:"291px"});
        $('#imgfor_con_clu').css({width:fa1_wid+235,height:"291px"});
        com_obj.css({width:"246px",height:"291px"});
...
com.control=function(){
    ...
    R.click(function(){
        if(!obj.is(":animated")) com.x--;
        if(com.x<0){
            movecon.style.left=-(Imgwid)*com_obj.length+'px';
...
com.XM_start({name:"imgfor_con_roll",speed:1500,width:870,height:150});