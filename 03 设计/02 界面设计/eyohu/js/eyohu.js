/**
 * Created by eyohu023 on 2015/6/1.
 */
$(function() {
    ...
    var span = $(".solution_head span");
    var sdiv = $(".solution_content_div");
    span.each(function(i){
        $(this).on("click",function(){
            sdiv.eq(i).removeClass("block").addClass("hide");
            sdiv.eq(i).siblings().removeClass("hide").addClass("block");
