<template>
	<div class="buy" style="margin-bottom:50px;">
	    ...
	    <x-number placeholder="不少于5双" title="数量" :value=1 :min=1 @on-change="changeNum"></x-number>
	    </group>
	    ...
	    <div class="bottom_btn">
	    	<x-button style="background:#51AAFE;color:#fff;" v-link="'/shoes/destine'">确定</x-button>
	    </div>
	</div>
</template>
