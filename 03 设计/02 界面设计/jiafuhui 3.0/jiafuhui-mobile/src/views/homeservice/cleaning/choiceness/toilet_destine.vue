...
<div class="destine">
	...
	<group class="area">
	  	<x-input :value.sync="number" title="服务数量" placeholder="1" keyboard="number" v-ref:input><span>间</span></x-input>
	</group>	
	...
	<div class="btn-panel">
      <x-button type="primary" style="background:#51AAFE;" v-link="'/cleaning/choiceness/toilet_pay'">下一步</x-button>
    </div>
</div>
</template>
