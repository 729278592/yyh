...
<div class="pay">
	...
	<div class="">
		<group>
			<div class="title_line">包月清洁</div>
		  	<cell title="服务时间" value="2016-7-10 14:00"></cell>
		  	<cell title="包月选择" value="1个月"></cell>
		  	<cell title="服务面积" value="260平米"></cell>
	...
	<div class="btn-panel"><x-button v-link="'../../user/monthly_ticket'" style="background:#51AAFE;color:#fff;">提交订单</x-button></div>
</div>
</template>
