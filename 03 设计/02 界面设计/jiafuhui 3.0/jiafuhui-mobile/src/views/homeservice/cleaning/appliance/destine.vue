...
<div class="destine">
	<group class="group-top">
	  	<cell title="点击设置或添加地址" is-link><i slot="icon" class="map icon-map-marker-o"></i></cell>
	</group>
	<flexbox>
	...
	<group class="area">
	  	<x-input :value.sync="area" title="服务数量" placeholder="1" keyboard v-ref:input><span>台</span></x-input>
	</group>	
	...
	<div class="btn-panel">
      <x-button type="primary"style="background:#51AAFE;" v-link="'/cleaning/appliance/pay'">下一步</x-button>
    </div>
</div>
</template>
