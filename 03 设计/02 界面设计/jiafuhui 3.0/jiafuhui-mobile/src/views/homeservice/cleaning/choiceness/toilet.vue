...
<div class="clean-public cookroom">
    ...
    <div class="bottom_btn">
    	<x-button style="background:#51AAFE;color:#fff;" v-link="'/cleaning/choiceness/toilet_destine'">立即预约</x-button>
    </div>
</div>
</template>
<script>
    ...
    export default {
      ...
      ready () {
        document.title = '服务详情'
        this.$progress.start()
        this.$http.get('/static/data/toilet.json').then((response) => {
