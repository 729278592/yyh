...
<div class="destine">
	...
	<group class="area">
		...
		<x-input :value.sync="area" title="房屋面积" placeholder="100" keyboard="number" keyboard="number" @on-change="onChooseArea" v-ref:input><span>平米</span></x-input>
	</group>	
	...
	<div class="btn-panel">
      <x-button type="primary"style="background:#51AAFE;" v-link="'/cleaning/daily/wasteland_pay'">下一步</x-button>
    </div>
</div>
</template>
