...
<div class="destine">
	...
	<group class="area">
	  	<x-input :value.sync="area" title="服务数量" placeholder="1" keyboard="number" v-ref:input><span>台</span></x-input>
	</group>	
	...
	<div class="btn-panel">
      <x-button type="primary"style="background:#51AAFE;" v-link="'/cleaning/appliance/icebox_pay'">下一步</x-button>
    </div>
</div>
</template>
