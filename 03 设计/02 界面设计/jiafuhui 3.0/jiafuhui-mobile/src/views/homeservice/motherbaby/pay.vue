...
<div class="pay">
	<group class="group-top">
	  	<cell :value.ync="address" title="毛毛 18089765479" inline-desc="四川省成都市武侯区 高朋大道高新科技工业园D座5楼"  is-link><i slot="icon" class="map icon-map-marker-o"></i></cell>
	</group>
	<div class="">
		<group>
			<!-- 判断 -->
			<div class="title_line">催乳师</div>
		  	<cell :value.ync="hour" title="服务时间" value="2016-7-10 14:00"></cell>
		  	<!--催乳师显示 次数  入户指导显示时长-->
		  	<cell :value.ync="times" title="服务次数" value="1"></cell>
		  	<cell :value.ync="duration" title="服务时长" value="2小时"></cell>
		  	<cell class="cell_color" title="服务费" value="80.00元"></cell>
		</group>
	...
	<div class="add-pay">合计：<div><span>398</span>.00元</div></div>
