...
<div class="nursing_level" v-for="item in list">
    ...
    <div class="list">
	    <flexbox>
	      	...
	      	<flexbox-item v-link=""><div class="item item-active">二级护工</div></flexbox-item>
    ...
    <div class="bottom_btn">
    	<x-button style="background:#51AAFE;color:#fff;" v-link="'/nursing/destine2'">立即预约</x-button>
    </div>
</div>
</template>
...
<script>
  ...
  export default {
    ...
    ready () {
      document.title = '服务详情'
      this.$progress.start()
      this.$http.get('/static/data/level2.json').then((response) => {
