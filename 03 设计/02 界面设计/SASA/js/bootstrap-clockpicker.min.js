...
!function () {
    ...
    function s(s, n) {
        ...
        for (x = 0; 24 > x; x += 1) {
            ...
            E.css({left: g + Math.sin(S) * P - w, top: g - Math.cos(S) * P - w}), D && E.css("font-size", "120%"), E.html(0 === x ? "00" : x), v.append(E), E.on(u, a)
        }
        for (x = 0; 60 > x; x += 5)E = I.clone(), S = x / 30 * Math.PI, E.css({left: g + Math.sin(S) * m - w, top: g - Math.cos(S) * m - w}), E.css("font-size", "120%"), E.html(i(x)), f.append(E), E.on(u, a);
    ...
    s.DEFAULTS = {"default": "", fromnow: 0, placement: "bottom", align: "left", donetext: "完成", autoclose: !1, vibrate: !0}, s.prototype.toggle = function () {
