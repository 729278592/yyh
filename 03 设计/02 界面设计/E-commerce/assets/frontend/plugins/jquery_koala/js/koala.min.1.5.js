(function () {
    ...
    (function () {
        var l = {};
        var k = g.DOMEvent = g.E = new g.Type("DOMEvent",
            function (m, q) {
                if (!q) {
                    q = window
                }
    ...
    var j = function () {
        ...
        if (_doc.addEventListener) {
            ...
            if (_doc.attachEvent) {
                _doc.attachEvent("onreadystatechange",
                    function () {
...
(function () {
    var b = document,
        ...
        d = function (l, p, r, k, o) {
            ...
            e[l] = true;
            var q,
                m = p || l.toLowerCase().substring(l.lastIndexOf(".") + 1);
            if (m === "js") {
