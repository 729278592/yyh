...
jQuery.fn.extend({jCountdown: function () {
    var B = function (b) {
        ...
        this.frame = function (a) {
            if (void 0 == a)return this._frame;
            this._frame = a;
            var a = -this.value() * this.height(), b = Math.sin((this.frame() - 1) / (this.totalFrames() - 1) * Math.PI / 2);
        ...
        this.timeFormat = function (b, a, c, d, e) {
            var b = Math.floor(b / 1E3), f = b % 60, g = Math.floor(b % 3600 / 60), h = Math.floor(b % 86400 / 3600);
        ...
        this.time = function (b, a) {
            this._timeText = b;
            this._timeZone = a;
            var c = this._timeText.split("/").join(" ").split(":").join(" ").split(" "), d = parseInt(c[0], 10), e = parseInt(c[1], 10) - 1, f = parseInt(c[2], 10), g = parseInt(c[3], 10), h = parseInt(c[4], 10) - 60 * this._timeZone, c = parseInt(c[5], 10);
    ...
    if (0 < arguments.length) {
        ...
        if (1 == arguments.length && "object" == typeof arguments[0]) {
            ...
            var j = parseInt(jQuery.browser.version, 10), y = "string" == typeof e.timeText ? e.timeText : "", t = parseFloat(e.timeZone);
            isNaN(t) && (t = 0);
