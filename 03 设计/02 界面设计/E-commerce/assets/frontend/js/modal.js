		...
		var content  = '<div id="'+opts.id+'"><div class="ts_head"><span>'+opts.title+'</span><span class="block close">×</span></div>'+
				       '<div class="ts_body">' +
                            '<form action="" class="form1">'+
                                ...
                                '<span class="login_password">登录密码:</span><a  href="../frontent/confirm_account_number.html" class="forget_password">忘记密码?</a><br>'+
                                ...
                                '<a href="../frontent/registered.html" class="free_register">免费注册</a>'+
                            '</form>'+
                       '</div>'+
                       '<div class="ts_foot">'+
